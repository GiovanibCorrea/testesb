...
$i++;
$cfg['Servers'][$i]['host'] 			= 'mysqlesfera.mysql.database.azure.com';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '{IojU(\\?omwmaM;xQk9X$gSKm2U-c);5' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_wsgm1TrxpbFkMdZo5u2tQNq/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);

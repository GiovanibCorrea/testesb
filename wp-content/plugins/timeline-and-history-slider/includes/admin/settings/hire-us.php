...
<div class="wrap">
	...
	<div class="support-data">
		...
		<ul>
			<li><?php _e( 'Hire once, get unlimited jobs done', 'timeline-and-history-slider' ); ?></li>
			<li><?php _e( 'Quick ticket support, quick solution', 'timeline-and-history-slider' ); ?></li>
			<li><?php _e( 'Any sort of WP work with no extra cost', 'timeline-and-history-slider' ); ?></li>
			<li><?php _e( 'Dedicated expert working only for you!', 'timeline-and-history-slider' ); ?></li>
		</ul>
	</div>	
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		<th>
	    			<h2><?php _e( 'Hire us for 1 Hr', 'timeline-and-history-slider' ); ?></h2>
	    			<p>$20 USD</p>
	    		</th>
	    		<th>
	    			<h2><?php _e( 'Hire us for 5 Hrs', 'timeline-and-history-slider' ); ?></h2>
	    			<p>$99 USD</p>
	    		</th>
	    		<th>
	    			<h2><?php _e( 'Hire us for 30 Hrs', 'timeline-and-history-slider' ); ?></h2>
	    			<p>$499 USD</p>
	    			<p class="promo"><?php _e( 'Our most valuable package!', 'timeline-and-history-slider' ); ?></p>
	    		</th>
				<th>
	    			<h2><?php _e( 'Hire us for 70 Hrs', 'timeline-and-history-slider' ); ?></h2>
	    			<p>$999 USD</p>
	    		</th>
	    	</tr>
	    </thead>
	    ...
	    <tfoot>
	    	<tr>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=6&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'timeline-and-history-slider' ); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'timeline-and-history-slider' ); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=4&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'timeline-and-history-slider' ); ?></a></td>
				<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=5&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'timeline-and-history-slider' ); ?></a></td>
			</tr>
	    </tfoot>
	</table>
</div>